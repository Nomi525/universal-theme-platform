...
const catalog = [
    ...
    },
    {
        ...
        defaultSettings: {
            ...
            desktop_footer_about_us_content: "Welcome to our store! We're here to bring you quality products and services with convenience, care, and trust.",
    ...
    },
    {
        ...
        defaultSettings: {
            ...
            background_image_url: "https://images.unsplash.com/photo-1512496015851-a90fb38ba796?q=80&w=1600&auto=format&fit=crop",
            ...
            made_with_icon_url: "https://minis-media-assets.swiggy.com/swiggymini/image/upload/h_128,c_fit,fl_lossy,q_auto:eco,f_auto/IMAGE/847486d0-db3e-4d54-bee7-b537747c7ecd/0gZi8UlkP9cWIQrrlQF1u-B63F0C50-8D0C-4529-AC08-1613096E9E43.png",
            // spacing
            inset_padding: 14,
            // misc
            custom_css: null,
    ...
    // --- FLASH SALE BLOCKS -------------------------------------------------------
    {
        ...
        defaultSettings: {
            ...
            background_image: "https://moosend.com/wp-content/uploads/2024/12/flash_sales_email_examples.png",
    ...
    // --- end FLASH SALE ----------------------------------------------------------
    {
        ...
        defaultSettings: {
            ...
            item1: {
                ...
                icon_img: "https://upload.wikimedia.org/wikipedia/commons/a/a5/Instagram_icon.png",
            ...
            item2: {
                ...
                icon_img: "https://upload.wikimedia.org/wikipedia/commons/4/42/YouTube_icon_%282013-2017%29.png",
                icon_bg: "#FF0000",
                icon_color: "#ffffff",
            },
            item3: {
                ...
                icon_img: "https://upload.wikimedia.org/wikipedia/commons/1/1b/Facebook_icon.svg",
                icon_bg: "#1877F2",
                icon_color: "#ffffff",
            },
            ...
            item4: {
                ...
                icon_img: "data:image/svg+xml;utf8,<svg xmlns='http://www.w3.org/2000/svg' viewBox='0 0 24 24' fill='%23111827'><path d='M12 3a3 3 0 0 0-3 3v6a3 3 0 0 0 6 0V6a3 3 0 0 0-3-3z'/><path d='M5 11a1 1 0 1 0-2 0c0 4.08 3.06 7.44 7 7.93V22h4v-3.07c3.94-.49 7-3.85 7-7.93a1 1 0 1 0-2 0 6 6 0 0 1-12 0z'/></svg>",
    ...
    },
    {
        ...
        defaultSettings: {
            ...
            highlights: [
                {
                    name: "Shoot Day",
                    cover: "https://images.unsplash.com/photo-1526170375885-4d8ecf77b99f?w=600&auto=format&fit=crop",
                    images: [
                ...
                {
                    name: "Arizona",
                    cover: "https://images.unsplash.com/photo-1543352634-873e4fc5d8fd?w=600&auto=format&fit=crop",
                    images: [
                    ...
                    fields: [
                        {
                            path: "highlights",
                            type: "textarea",
                            label: "Highlights (JSON array, each with name, cover, images[≤3])",
                        },
                    ],
                },
                {
    ...
    },
    {
        ...
        defaultSettings: {
            ...
            items: [
                {
                    image: "https://images.unsplash.com/photo-1604908554007-4b0b1b2d9a8b?w=1600&q=80&auto=format&fit=crop",
                ...
                {
                    image: "https://images.unsplash.com/photo-1544025162-d76694265947?w=1600&q=80&auto=format&fit=crop",
                ...
                {
                    image: "https://images.unsplash.com/photo-1555939594-58d7cb561ad1?w=1600&q=80&auto=format&fit=crop",
                    title: "Bowls & Salads",
                    subtitle: "Fresh picks",
                    ctaLabel: "Explore",
                    href: "/collections/bowls",
                    gradient: "linear-gradient(180deg, rgba(0,0,0,0) 10%, rgba(0,0,0,0.75) 100%)",
                },
            ],
            // card look
            radius: 16,
                ...
                },
                {
                    ...
                    fields: [
                        ...
                        },
                        {
                            path: "items",
                            type: "textarea",
                            label: "Advanced items JSON (optional: image, title, subtitle, badge, ctaLabel, href, gradient)",
                        },
                    ],
                },
                {
            ...
            testimonials: [
                {
                    ...
                    stars: 5,
                    feedback: "Love the design and customization of InstaGrow. We’ve used various apps before but none this flexible.",
                },
                {
                    name: "Gaurav Khe",
                    ...
                    stars: 5,
                    feedback: "I like the flexibility and customization options. No custom CSS required — works out of the box.",
                },
                {
                    name: "Marian Campos",
                    role: "Entrepreneur",
                    ...
                    stars: 4,
                    feedback: "A very well-done plugin that now works exactly as advertised. Best Facebook integration I’ve used.",
                },
            ],
            // card UI
            card_radius: "lg",
                    ...
                    fields: [
                        {
                            path: "testimonials",
                            type: "textarea",
                            label: "Testimonials JSON (name, role, company, avatar, stars, feedback)",
                        },
                    ],
                },
                {
                    ...
                    fields: [
                        {
                            path: "items",
                            type: "textarea",
                            label: "Coupons JSON (array of {enabled,badge_text,badge_bg,badge_color,title,subtitle,href})",
                        },
                    ],
                },
                {
...
async function main() {
    ...
    for (const c of catalog) {
        ...
        const normalizedSettingsSchema = typeof c.settingsSchema === "undefined"
            ? undefined
    ...
    const jsonAsObject = (v) => typeof v === "object" && v !== null && !Array.isArray(v)
        ? v
        : {};
        ...
        await prisma.themeDesignElement.createMany({
            data: [
                ...
                },
                {
                    ...
                    code: "top_nav",
                    position: 2,
                    settings: topNav.defaultSettings,
                },
                // NEW: Store Hero
                {
                    themeId: defaultTheme.id,
                    ...
                    code: "store_hero",
                    position: 3,
                    settings: storeHero.defaultSettings,
                },
                {
                    themeId: defaultTheme.id,
                ...
                },
                {
                    ...
                    settings: storeStats.defaultSettings,
                },
                {
                    themeId: defaultTheme.id,
                ...
                },
                {
                    ...
                    code: "social_proof_strip",
                    position: 8,
                    settings: socialStrip.defaultSettings,
                },
                // NEW: Story Highlights
                {
                    ...
                    code: "story_highlights",
                    position: 9,
                    settings: storyHighlights.defaultSettings,
                },
                mainCoupon && {
                    themeId: defaultTheme.id,
                    ...
                    settings: mainCoupon.defaultSettings,
                },
                {
                    themeId: defaultTheme.id,
                    ...
                    code: "offers_collections",
                    position: 11,
                    settings: offersCollections.defaultSettings,
                },
                ...
                },
                {
                    ...
                    settings: aboutUs.defaultSettings,
                },
                {
                    themeId: defaultTheme.id,
                    ...
                    code: "bottom_nav",
                    position: 15,
                    settings: bottomNav.defaultSettings,
                },
            ],
        });
    }
  ...
  <img src="https://foodomaa.sgp1.cdn.digitaloceanspaces.com/demo_electronics/other/0f96dd56-8748-4bb7-8ca2-23d9776e60b4.png" class="w-1/2 h-auto sm:w-full object-cover rounded-lg">
                ...
                },
                {
                    ...
                    settings: {
                        ...
                        hero_image: "https://foodomaa.sgp1.cdn.digitaloceanspaces.com/fourth/product_horizontal_strip/54f6f64c-e879-4069-9291-408b57c8730d.gif",
                    },
                },
                {
                    themeId: volt.id,
    ...
    const normalizePrice = (n) => n >= 10000 ? Math.round(n) : Math.round(n * 100);
